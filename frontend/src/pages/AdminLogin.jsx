...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("adminName", name || (role === "superadmin" ? "Super Admin" : "Officer"));

      console.log("Role stored:", role);
      console.log("Redirecting to:", role === "superadmin" ? "/superadmin/dashboard" : "/admin/dashboard");
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-800 mb-2">Officer Login</h2>
            <p className="text-gray-600">Sign in to Admin portal</p>
          </div>
